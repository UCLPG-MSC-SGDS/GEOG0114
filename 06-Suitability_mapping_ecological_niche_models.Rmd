...
## Lecture recording (Length: 42:40 mins)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_msstream('3fc99219-cb40-4548-bb5a-6084b22e93a3') %>% use_align('center')
```

If the video does not play within this section, then try playing it from Microsoft Streams - you should be able to view it there using this [[**LINK**]](https://web.microsoftstream.com/video/3fc99219-cb40-4548-bb5a-6084b22e93a3).
...
```{r setpath_GEOG0114_wk5, include = FALSE}
knitr::opts_knit$set(root.dir = "/Volumes/Anwar-HHD/GEOG0114/Github/2022_2023/datasets/week-5")
