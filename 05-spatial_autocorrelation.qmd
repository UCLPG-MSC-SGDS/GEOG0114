...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/general/week3/image6_counts1.png', error = FALSE) 
```
...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/general/week3/image7_sqrtroot_counts1.png', error = FALSE) 
```
...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/general/week3/image12_conditions.png', error = FALSE) 
```
...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/general/week3/image11_map_significance1.png', error = FALSE) 
```
