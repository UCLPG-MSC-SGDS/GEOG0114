...
::: note
**IMPORTANT NOTE**: All materials (including lecture slides, recordings, data sets for practical & reading list etc.) for Week 7 and 8 are hosted on an alternative page [**Link**](https://jtvandijk.github.io/GEOG0114/index.html). 
:::
