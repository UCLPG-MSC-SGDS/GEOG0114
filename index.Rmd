...
You can download the lecture notes and datasets for the practical lesson from the table below.

**Week**| **Downloads**
------------ | -------------
1| Spatial analysis for data science: [**Slides**]; [**Data**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Week%201%20-%20Dataset.zip)
2| Graphical representation: [**Slides**]; [**Data**]
3| Spatial autcorrelation: [**Slides**]; [**Data**]
4| Suitability mapping I: [**Slides**]; [**Data**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Week%204%20-%20Dataset.zip)
5| Suitability mapping II: [**Slides**]; [**Data**]
6| Raster data and geostatistics: [**Slides**]; [**Data**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Week%206%20-%20Dataset.zip)
9| Spatial regression models I: [**Slides**]; [**Data**]
10| Spatial regression models II: [**Slides**]; [**Data**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Week%2010%20-%20Dataset.zip)
