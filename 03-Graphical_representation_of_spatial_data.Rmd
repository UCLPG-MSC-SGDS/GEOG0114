...
## Lecture recording (Length: 43:31 minutes)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_msstream('283a33f4-208b-499b-a483-212fa99b6279') %>% use_align('center')
```

If the video does not play within this section, then try playing it from Microsoft Streams - you should be able to view it there using this [[**LINK**]](https://web.microsoftstream.com/video/283a33f4-208b-499b-a483-212fa99b6279).

<div class="note">
**Important Notes:** Access to Microsoft Steams will may require use of your UCL institutional login details 
</div>

**Video for Coordinate Reference Systems (CRS) (Length: 17:53 minutes)**
```{r 03-data-visualisation-rosling, warnings=FALSE, message=FALSE, echo=FALSE}
embed_youtube('xJyJlKbZFlc') %>% use_align('center')
```
[[**Watch on YouTube**]](https://www.youtube.com/watch?v=xJyJlKbZFlc)
