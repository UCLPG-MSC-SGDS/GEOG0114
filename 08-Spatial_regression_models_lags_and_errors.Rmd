...
Before you begin do make sure to download all data by [**clicking here**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Week%2010%20-%20Dataset.zip). Create a folder on called "**Week 10**" within your "**GEOG0114**" folder stored in the desktop of your personal computer. Make sure to extract all data from the zip folder and store it into "**Week 10**" folder. Open a new R script and set the work directory to **Week 10's** folder.

For Windows, the work directory will be:

```{r, eval = FALSE}
setwd("C:/Users/AccountName/Desktop/GEOG0114/Week 10")
```

For MAC, the work directory will be:

```{r, eval = FALSE}
setwd("/Users/AccountName/Desktop/GEOG0114/Week 10")
```
...
<div class="note">
**IMPORTANT NOTES:** The above results presented in the above table indicates the relationship between the dependent and
