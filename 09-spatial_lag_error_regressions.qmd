...
Before you begin do make sure to download all data by [**clicking here**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Week%207%20-%20Dataset.zip). Create a folder on called "**Week 7**" within your "**GEOG0114**" folder stored in the desktop of your personal computer. Make sure to extract all data from the zip folder and store it into "**Week 7**" folder. Open a new R script and set the work directory to **Week 7's** folder.
...
1. **Spatial Regression in R (Part One): The Four Simplest Models (Length: 00:40:36)** [[**Watch on YouTube**]](https://youtu.be/b3HtV2Mhmvk)
