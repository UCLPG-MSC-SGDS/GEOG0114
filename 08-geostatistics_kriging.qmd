...
:::{.callout-note}
Two important assumptions of a basic semivariogram are that the spatial process under investigation are: i.)
...
## Demonstrations of Kriging regression model
...
:::{.callout-important}
Have a go at these questions before using solution codes which can be downloaded from [**[HERE]**](https://github.com/UCLPG-MSC-SGDS/GEOG0114/raw/main/Solutions%206.zip)
:::
