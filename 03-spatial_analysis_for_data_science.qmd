...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/general/week1/Image10_solutionmap.png', error = FALSE) 
```
...
knitr::opts_knit$set(root.dir = "/Users/anwarmusah/Documents/Websites/GEOG0114/all_datasets/Week 1 - Dataset")
knitr::opts_chunk$set(cache = FALSE)
```

Load the required packages:

```{r loading_packages_wk1, include = FALSE}
library("tmap")
library("sf")
```
